...
const Dashboard = () => {
  ...
  const { mutate: deleteFile, isPending } =
    trpc.file.deleteFileByUserId.useMutation({
      onSuccess: () => {
          ...
          {files
            ...
            .map(file => (
              ...
              >
                ...
                >
                  <div className='space-x flex w-full items-center justify-between px-6 pt-6'>
                    <div className='to-blue-5 h-10 w-10 flex-shrink-0 rounded-full bg-gradient-to-r from-cyan-500' />
